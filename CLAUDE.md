...
- **Auth**: account database fields now include unique emails, email-verification state, password hashes, and timestamps for students and admins. Session handling and login/sign-up routes are not yet implemented; a reference prototype in a sibling project used `better-auth` as a starting point.
